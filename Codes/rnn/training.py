...
if __name__ == '__main__':
    ...
    # job parameters
    parser.add_argument('--jobid', type = str, default = 'reward=1.0_sample_cost=0.01_urgency_cost=0.005_logLR=[-0.9,0.9]_max_samples=10000_max_steps=10000_epNum=1500000', help = 'job id')
    ...
    parser.add_argument('--urgency_cost', type = float, default = 0.002, help = 'urgency cost')
